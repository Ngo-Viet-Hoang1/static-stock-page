...
const Hero: React.FC<HeroProps> = ({ isDark }) => {
  return (
    <section
      className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-dark-950 transition-colors duration-300"
      id="home"
    >
      {/* 3D Background */}
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-100/80 dark:bg-gold-400/10 border border-yellow-200 dark:border-gold-400/20 mb-6 backdrop-blur-sm shadow-sm">
            ...
            <span className="text-yellow-700 dark:text-gold-400 text-xs font-semibold uppercase tracking-wider">
              Khóa học Premium K52 đang mở
            </span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 text-slate-900 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-white dark:via-gray-200 dark:to-gray-400 drop-shadow-sm">
            Làm Chủ <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-yellow-700 dark:from-gold-300 dark:to-yellow-600 filter drop-shadow-sm">
              Thị Trường
            </span>
          </h1>

          <p className="text-lg md:text-xl text-slate-600 dark:text-gray-300 mb-8 max-w-lg leading-relaxed font-light">
            Hệ thống giao dịch AHKT giúp bạn thấu hiểu dòng tiền, tối ưu hóa lợi
            nhuận và kiến tạo tự do tài chính bền vững.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <PlayCircle
                size={20}
                className="relative z-10 text-yellow-600 dark:text-gold-400 group-hover:scale-110 group-hover:text-yellow-500 dark:group-hover:text-yellow-200 transition-all duration-300"
              />

              {/* Text */}
              <span className="relative z-10 text-slate-700 dark:text-gray-300 group-hover:text-slate-900 dark:group-hover:text-white group-hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] transition-all duration-300">
                Xem Demo
              </span>
            </button>
          </div>
          ...
          <div className="mt-12 flex items-center gap-8">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map((i) => (
                <img
                  key={i}
                  className="w-10 h-10 rounded-full border-2 border-white dark:border-dark-800 shadow-md"
        ...
        >
          ...
          <div className="absolute inset-0 z-20 bg-white/70 dark:bg-slate-900/60 backdrop-blur-2xl border border-white/60 dark:border-white/10 rounded-3xl p-6 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.2)] dark:shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] flex flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10 h-32 w-full mb-6">
              ...
              >
                ...
                {/* Area Fill */}
                <path
                  d="M0,40 C20,35 30,45 50,20 S70,10 80,15 S90,5 100,0 V50 H0 Z"
                  fill="url(#chartGradient)"
                />
                {/* Stroke Line */}
                <path
                  d="M0,40 C20,35 30,45 50,20 S70,10 80,15 S90,5 100,0"
                  fill="none"
                  stroke="#EAB308"
                  strokeWidth="2"
                  strokeLinecap="round"
            ...
            <div className="relative z-10 space-y-3">
              ...
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center justify-between p-3 rounded-xl bg-slate-50/50 dark:bg-white/5 border border-slate-100 dark:border-white/5 hover:bg-white dark:hover:bg-white/10 transition-colors cursor-pointer"
                >
          ...
          >
            <div className="relative w-12 h-12">
              ...
              <div className="absolute top-0 right-0 w-3 h-3 bg-red-500 rounded-full border-2 border-white dark:border-slate-800 animate-ping"></div>
